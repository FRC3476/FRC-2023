...
public class TelescopingArm extends AbstractSubsystem {
    ...
    public void update() {
        ...
        logData("Wanted pos", state.position / Constants.TELESCOPING_ARM_ROTATIONS_PER_METER);
        logData("Wanted vel", state.velocity / Constants.TELESCOPING_ARM_ROTATIONS_PER_METER / 60);
